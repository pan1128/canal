...
public class TemplateConfigLoader {
    ...
    public static final String RDB_CONFIG_TMP="rdb.yml";
    public static final String APPLICATION_YML_CONFIG_TMP="application-template.yml";
    ...
    public static String loadRdbConfig(){
        return loadFile(RDB_CONFIG_TMP);
    }

    public static String loadApplicationYmlConfig(){
        return loadFile(APPLICATION_YML_CONFIG_TMP);
    }
